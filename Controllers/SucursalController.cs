...
namespace HerrProgLibreriaDigital.Controllers
{
    public class SucursalController : Controller
    {
        ...
        public async Task<IActionResult> Index(string filterName)
        {
            ...
            {
                query = query.Where(x =>x.NombreSucursal.ToLower().Contains(filterName.ToLower()));
            }

            var model = new SucursalViewModel();
            model.Sucursales =  await query.ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreSucursal,Direccion,Calificacion,Localidad,StockPermanente")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreSucursal,Direccion,Calificacion,Localidad,StockPermanente")] Sucursal sucursal)
        {
            if (id != sucursal.Id)
            {
                return NotFound();
